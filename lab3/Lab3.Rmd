...
```{r q6}
# ridge min MSE
print(paste("The minimum MSE is", round(min(ridge_abd$cvm), 4)))

# Lambda for min MSE
print(paste("The lambda value associated with the minimum MSE is", round(ridge_abd$lambda.min, 4)))
...
```{r q7}
# ridge min MSE
print(paste("The minimum MSE is", round(min(lasso_abd$cvm), 4)))

# Lambda for min MSE
print(paste("The lambda value associated with the minimum MSE is", round(lasso_abd$lambda.min, 4)))
